...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '83228a0c95a947dcabbf6ce52ed57f08',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || ' 你 好 呀 🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yuxiaoer', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '富二代的爹🍚', // 作者简介
  ...
  FONT_URL: [
    ...
    'https://g.alicdn.com/alidocs/common-fonts/0.0.3/static/media/DFHanziPenGB-Std.otf',
